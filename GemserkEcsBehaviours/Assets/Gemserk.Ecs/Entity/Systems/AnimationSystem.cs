...
public class AnimationCommandSystem : ComponentSystem
{
    ...
    protected override void OnUpdate()
    {
        ...
        Entities.WithAll<ModelInstance>().ForEach((Entity e, ref Animation animation, ref AnimationCommand command) => {
...
//        });
        ...
        Entities.WithAllReadOnly<AnimationPlaying>().ForEach((Entity e, ref Animation animation) => {
